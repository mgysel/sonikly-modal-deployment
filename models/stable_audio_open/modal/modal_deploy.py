...
def main(
    ...
    Example usage:
        modal run models/stable_audio_open/modal/modal_deploy.py --prompt "A peaceful guitar melody"
        modal run models/stable_audio_open/modal/modal_deploy.py --prompt "Upbeat electronic music" --duration 15 --steps 150
    """
