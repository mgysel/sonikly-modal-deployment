...
# ==============================================================================
# 4b. EXCLUDE FIRST 4252 PRESETS
# ==============================================================================
print(f"Initial Count: {len(serum_params)}")
print("✂️ Slicing out the first 4252 presets...")
...
osc_embeddings = osc_embeddings[start_index:]
osc_masks = osc_masks[start_index:]
...
# --- STAGE 2: TRAIN FLOW MATCHING (Deep + EMA + Cosine) ---
print("\n=== STAGE 2: Training Flow Matching (Deep Net + EMA + Cosine Decay) ===")
