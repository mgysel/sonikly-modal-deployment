...
class LatentDiffusionModel(tf.keras.Model):
    ...
    def generate(self, text_embeds, steps=50):
        """ Inference Loop (Reverse Diffusion) with JIT compilation """
        ...
        # Use DDIM-style sampling: subsample timesteps if steps < self.timesteps
        ...
        # Run the JIT-compiled diffusion loop
