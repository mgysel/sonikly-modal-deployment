# -*- coding: utf-8 -*-
"""V2.7 Conditional VAE - Latent Diffusion - ResMLP - Retrained.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mXM_Isujx4_Wynv8zeSpZaikiUL3Ja7e
...
class LatentDiffusionModel(tf.keras.Model):
    ...
    def generate(self, text_embeds, steps=50):
        # Basic gen loop (Inference usually handles CFG scale externally)
...
# Cell 3.3 — Model Builders (Restored to Linear Champion)
...
# (ResMLP Denoiser remains unchanged as it works well)
...
# Cell 3.4 — Final SOTA Training (Cyclical Beta + Golden Config + CFG)
...
width = 512
batch_size = 64
dropout_rate = 0.2      # <--- Updated to match Golden Config
beta_max = 1.0         # <--- The Winner (High-Fi)

# Training Duration
vae_epochs = 100        # Extended for cycles
diffusion_epochs = 60
...
class CyclicalBetaAnnealing(tf.keras.callbacks.Callback):
    ...
    def on_epoch_begin(self, epoch, logs=None):
        ...
        # Schedule: Linear Ramp (0-50%), Hold (50-100%)
        if cycle_pos < 0.5:
...
# --- STAGE 1: TRAIN VAE ---
print(f"\n=== STAGE 1: Training VAE (Cyclical Beta {beta_max} | Drop {dropout_rate}) ===")

tf.keras.backend.clear_session()

# Linear Builders (Dropout 0.2)
...
# Initialize VAE (Start Beta at 0.0)
...
# Save VAE
vae_save_path = os.path.join(SAVE_DIR, "vae_stage1_sota_cyclical.keras")
vae.save(vae_save_path)
print(f"✅ VAE Saved to {vae_save_path}")

# --- STAGE 2: TRAIN FLOW MATCHING (With CFG) ---
print("\n=== STAGE 2: Training Flow Matching (CFG Enabled) ===")
...
ldm_save_path = os.path.join(SAVE_DIR, "ldm_final_sota_cfg.keras")
