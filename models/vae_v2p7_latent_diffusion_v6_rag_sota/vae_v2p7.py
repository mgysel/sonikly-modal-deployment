...
class VAE_V2P7:
    ...
    def retrieve_closest_preset(self, target_emb):
        """Finds closest preset using Cosine Similarity."""
        ...
        # print(f"🔎 RAG Match: {best_idx} (Score: {scores[best_idx]:.4f})")
    ...
    def generate(self, text_description, diffusion_steps=None, head_noise_level=0.0,
                 ...
                 use_rag=False, rag_strength=0.8, verbose=True):
        ...
        if use_rag and self.rag_data is not None:
            try:
                if verbose: print("🔎 Performing RAG Retrieval...")
